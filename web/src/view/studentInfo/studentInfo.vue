<template>
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="入学年份" prop="admissionYear">
             ...
             <el-input v-model.number="searchInfo.admissionYear" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="生源地" prop="originPlace">
         <el-input v-model="searchInfo.originPlace" placeholder="搜索条件" />
        ...
        <el-form-item label="班级" prop="class">
         <el-input v-model="searchInfo.class" placeholder="搜索条件" />

        </el-form-item>
        <el-form-item label="寝室" prop="dormitory">
         <el-input v-model="searchInfo.dormitory" placeholder="搜索条件" />
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="身份证" prop="idCard" width="120" />
        <el-table-column align="left" label="录取通知书编号" prop="admissionLetterId" width="120" />
        <el-table-column align="left" label="入学年份" prop="admissionYear" width="120" />
        <el-table-column align="left" label="生源地" prop="originPlace" width="120" />
        <el-table-column align="left" label="校区" prop="campus" width="120" />
        ...
        <el-table-column align="left" label="班级" prop="class" width="120" />
        <el-table-column align="left" label="寝室" prop="dormitory" width="120" />
          <el-table-column label="人像" width="200">
              <template #default="scope">
                <el-image style="width: 100px; height: 100px" :src="getUrl(scope.row.portrait)" fit="cover"/>
              </template>
          </el-table-column>
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateStudentInfoFunc(scope.row)">变更</el-button>
      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="录取通知书编号:"  prop="admissionLetterId" >
              <el-input v-model="formData.admissionLetterId" :clearable="true"  placeholder="请输入录取通知书编号" />
            </el-form-item>
            <el-form-item label="入学年份:"  prop="admissionYear" >
              <el-input v-model.number="formData.admissionYear" :clearable="true" placeholder="请输入入学年份" />
            </el-form-item>
            <el-form-item label="生源地:"  prop="originPlace" >
              <el-input v-model="formData.originPlace" :clearable="true"  placeholder="请输入生源地" />
            </el-form-item>
            <el-form-item label="校区:"  prop="campus" >
              <el-input v-model="formData.campus" :clearable="true"  placeholder="请输入校区" />
            </el-form-item>
            <el-form-item label="学号:"  prop="studentId" >
              <el-input v-model="formData.studentId" :clearable="true"  placeholder="请输入学号" />
            </el-form-item>
            <el-form-item label="学院:"  prop="college" >
              <el-input v-model="formData.college" :clearable="true"  placeholder="请输入学院" />
            </el-form-item>
            <el-form-item label="专业:"  prop="major" >
              <el-input v-model="formData.major" :clearable="true"  placeholder="请输入专业" />
            </el-form-item>
            <el-form-item label="班级:"  prop="class" >
              <el-input v-model="formData.class" :clearable="true"  placeholder="请输入班级" />
            </el-form-item>
            <el-form-item label="寝室:"  prop="dormitory" >
              <el-input v-model="formData.dormitory" :clearable="true"  placeholder="请输入寝室" />
            </el-form-item>
      ...
      <el-scrollbar height="550px">
        <el-descriptions column="1" border>
                ...
                <el-descriptions-item label="人像">
                        <el-image style="width: 50px; height: 50px" :preview-src-list="ReturnArrImg(formData.portrait)" :src="getUrl(formData.portrait)" fit="cover" />
                </el-descriptions-item>
