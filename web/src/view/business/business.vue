<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="封面图" prop="pic" width="120" />
        <el-table-column align="left" label="地址" prop="address" width="120" />
        <el-table-column align="left" label="导航地址" prop="loc" width="120" />
        <el-table-column align="left" label="营业时间" prop="businessHours" width="120" />
        ...
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button type="primary" link icon="edit" class="table-button" @click="updateBusinessFunc(scope.row)">变更</el-button>
      ...
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="封面图:"  prop="pic" >
              <el-input v-model="formData.pic" :clearable="true"  placeholder="请输入封面图" />
            </el-form-item>
            <el-form-item label="地址:"  prop="address" >
              <el-input v-model="formData.address" :clearable="true"  placeholder="请输入地址" />
            </el-form-item>
            <el-form-item label="导航地址:"  prop="loc" >
              <el-input v-model="formData.loc" :clearable="true"  placeholder="请输入导航地址" />
            </el-form-item>
            <el-form-item label="营业时间:"  prop="businessHours" >
              <el-input v-model="formData.businessHours" :clearable="true"  placeholder="请输入营业时间" />
            </el-form-item>
    ...
    <el-dialog v-model="detailShow" style="width: 800px" lock-scroll :before-close="closeDetailShow" title="查看详情" destroy-on-close>
      <el-scrollbar height="550px">
        <el-descriptions column="1" border>
                ...
                <el-descriptions-item label="导航地址">
                        {{ formData.loc }}
                </el-descriptions-item>
