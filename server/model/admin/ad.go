...
type Ad struct {
	global.GVA_MODEL
	AdvertiserId    uint           `json:"advertiserId" form:"advertiserId" gorm:"column:advertiser_id;comment:;"`                   //所属广告主
	...
	Img             string         `json:"img" form:"img" gorm:"column:img;comment:;"`                                               //图片
	Video           string         `json:"video" form:"video" gorm:"column:video;comment:;"`                                         //视频
	Link            string         `json:"link" form:"link" gorm:"column:link;comment:;"`                                            //跳转链接
	AdCategory      *int           `json:"adCategory" form:"adCategory" gorm:"column:ad_category;comment:;"binding:"required"`       //广告类型
